      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 mb-10">
            <StatCard icon={Package} label="Pharmacies" value={stats.pharmacies?.total ?? 0} color={brandBlue} />
            <StatCard icon={CheckCircle} label="Verified Pharmacies" value={stats.pharmacies?.verified ?? 0} color={brandGreen} />
            <StatCard icon={ShoppingBag} label="Medications" value={stats.medications?.total ?? 0} color={brandBlue} />
            <StatCard icon={FileText} label="Prescriptions" value={stats.prescriptions?.total ?? 0} color={brandBlue} />
            <StatCard icon={Clock} label="Pending Prescriptions" value={stats.prescriptions?.pending ?? 0} color={brandGreen} />
            <StatCard icon={Users} label="Users" value={stats.users?.total ?? 0} color={brandBlue} />

            {/* Drug Classification */}
            <StatCard icon={Layers} label="Anatomical Classes" value={stats.anatomicalClasses?.total ?? 0} color={brandBlue} />
            <StatCard icon={FlaskConical} label="Therapeutic Classes" value={stats.therapeuticClasses?.total ?? 0} color={brandBlue} />
            <StatCard icon={Beaker} label="Pharmacological Classes" value={stats.pharmacologicalClasses?.total ?? 0} color={brandBlue} />
            <StatCard icon={Beaker} label="Chemical Classes" value={stats.chemicalClasses?.total ?? 0} color={brandBlue} />
            <StatCard icon={Beaker} label="Chemical Substances" value={stats.chemicalSubstances?.total ?? 0} color={brandBlue} />
            <StatCard icon={Pill} label="Generic Names" value={stats.genericNames?.total ?? 0} color={brandBlue} />
            <StatCard icon={Pill} label="Active Substances" value={stats.activeSubstances?.total ?? 0} color={brandBlue} />
