...
export const metadata = {
  title: 'Manzu - Lab Portal',
  description: 'Manage your lab with Manzu’s professional tools.',
};
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-gray-50/95 to-gray-100/95">
      <header className="sticky top-0 z-50 bg-gradient-to-r from-white/95 to-gray-50/95 border-b border-gray-100/20 backdrop-blur-lg shadow-[0_4px_20px_rgba(0,0,0,0.05)]">
        <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex space-x-2">
            ...
            >
              <Link href="/lab/dashboard">Dashboard</Link>
            </Button>
            <Button
              variant="ghost"
              asChild
            ...
            >
              <Link href="/lab/inventory">Inventory</Link>
            </Button>
            <Button
              variant="ghost"
              asChild
            ...
            >
              <Link href="/lab/profile">Profile</Link>
            </Button>
          </div>
        </nav>
      </header>
      <main
        ...
        role="main"
        aria-label="Lab dashboard content"
      >
        <Suspense
          fallback={
