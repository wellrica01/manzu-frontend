              ...
              <div className="flex items-center gap-3">
                {daysUntilExpiry < 0 ? (
                  <>
                    ...
                    <div>
                      <p className="font-medium text-red-900">This medication has expired!</p>
                      <p className="text-sm text-red-700">Expired {Math.abs(daysUntilExpiry)} days ago</p>
                    </div>
                  </>
                ) : daysUntilExpiry < 30 ? (
                  <>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-orange-700">Expires in {daysUntilExpiry} days</p>
                    </div>
                  </>
                ) : daysUntilExpiry < 90 ? (
                  <>
                    ...
                    <div>
                      <p className="font-medium text-yellow-900">Approaching expiry</p>
                      <p className="text-sm text-yellow-700">Expires in {daysUntilExpiry} days</p>
                    </div>
                  </>
                ) : (
                  <>
                    ...
                    <div>
                      <p className="font-medium text-green-900">Good expiry date</p>
                      <p className="text-sm text-green-700">Expires in {daysUntilExpiry} days</p>
                    </div>
                  </>
                )}
              </div>
