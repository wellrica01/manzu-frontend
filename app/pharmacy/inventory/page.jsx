...
const stats = {
  ...
  const formatExpiryDate = (date) => {
    ...
    if (daysUntilExpiry < 0) {
      ...
      return <span className="text-orange-600 font-medium">{expiryDate.toLocaleDateString()}</span>;
    } else {
      return <span className="text-gray-900">{expiryDate.toLocaleDateString()}</span>;
    }
  };
...
const formatStrengths = (ingredients) => {
  ...
  const renderMobileCard = (item) => (
    <div key={item.medicationId} className="bg-white border border-gray-200 rounded-lg p-4 mb-3 shadow-sm hover:shadow-md transition-shadow">
      <div className="flex justify-between items-start mb-3">
        <div className="flex-1">
          ...
          <p className="text-gray-600 text-sm max-w-xs truncate">
            {item.activeSubstances || "Unknown Ingredients"}
          </p>
          <p className="text-gray-600 text-sm max-w-xs truncate">
      ...
      <div className="grid grid-cols-2 gap-3 text-sm">
        ...
        <div>
          ...
          <p className="text-gray-900">{formatExpiryDate(item.expiryDate)}</p>
        </div>
      </div>
  ...
  return (
    <div className="space-y-6">
        ...
        <Dialog open={!!deleteId} onClose={() => setDeleteId(null)} title="Confirm Delete">
          <div className="mb-6">
            <div className="flex items-center gap-3 p-4 bg-red-50 rounded-lg border border-red-200">
              ...
              <div>
                <p className="text-red-800 font-medium">Are you sure you want to delete this inventory item?</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white border-2 border-red-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-3xl font-bold text-red-600">{summary.outOfStockCount}</div>
              <div className="text-xs text-gray-500 mt-1">Need restock</div>
            </div>
          </div>
        </div>
      ...
      {/* Optional: Add expiring soon alert */}
