import { CheckCircle, AlertCircle, Clock, AlertTriangle, XCircle } from 'lucide-react';
...
export const TAB_CONFIG = {
  ...
  expired: { // NEW: Add expired tab config
    id: 'expired',
...
export function getAvailableTabs(segments) {
  ...
  // NEW: Add expired tab if there are expired prescriptions
  if (segments.expiredPrescription && segments.expiredPrescription.length > 0) {
    tabs.push({ ...TAB_CONFIG.expired, count: segments.expiredItemsCount });
  }
