...
const resources = {
  en: {
    translation: {
      hero: {
        trusted_platform: 'NAFDAC-Compliant Platform', 
        first_in_nigeria: "Nigeria's First Medication Discovery Platform",         title: 'Discover Medications with',
        subtitle: 'Instantly discover medications from nearby pharmacies, compare prices, and order for delivery or pickup across Nigeria.',        find_medications: 'Find Medications',
      ...
      services: {
        ...
        pharmacy_benefits: 'Reach customers actively searching for medications you stock. Manage inventory easily, gain valuable market insights, and grow your revenue stream.',        register_pharmacy: 'Register Pharmacy',
  ...
  ha: {
    translation: {
      hero: {
trusted_platform: 'Dandalin Da NAFDAC Ta Amince Da Shi',
first_in_nigeria: 'Dandalin Farko Na Gano Magunguna A Najeriya',        title: 'Gano Magunguna da',
  ...
  yo: {
    translation: {
      hero: {
trusted_platform: 'Ipele Ti NAFDAC Fọwọsi',
first_in_nigeria: 'Ipele Akọkọ Ti Awari Ọgwu Ni Nigeria',        title: 'Ṣe awari Oogun pẹlu',
  ...
  ig: {
    translation: {
      hero: {
trusted_platform: 'Ikpo Okwu NAFDAC Kwadoro',
first_in_nigeria: 'Ikpo Okwu Mbụ Nchọta Ọgwụ Na Nigeria',        title: 'Chọpụta Ọgwụ na',
