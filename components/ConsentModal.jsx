...
export default function ConsentModal({ isOpen, onClose }) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent
        className="sm:max-w-lg w-full max-h-[80vh] p-0 border-2 border-[#1ABA7F]/30 rounded-3xl bg-white/95 backdrop-blur-xl shadow-2xl animate-in zoom-in-95 fade-in duration-500 overflow-auto"
      ...
      >
        ...
        <div className="relative bg-gradient-to-r from-[#225F91]/10 to-[#1ABA7F]/10 p-4 sm:p-8 pb-6">
        ...
        {/* Content Section */}
        <div className="relative z-10 p-4 pt-2 space-y-6">
          {/* Main Description */}
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Button
              ...
              className="flex-1 h-12 p-3 text-sm font-bold rounded-lg bg-gradient-to-r from-[#225F91] to-[#1a4a73] hover:from-[#1a4a73] hover:to-[#225F91] text-white shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed group relative overflow-hidden"
            ...
            <Button
              asChild
              variant="outline"
              className="flex-1 h-12 p-3 text-sm font-bold rounded-xl border-2 border-[#225F91] text-[#225F91] hover:bg-[#225F91]/10 transition-all duration-300"
