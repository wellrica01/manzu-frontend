              ...
              <CardContent>
                {pharmacy.items.map((item) => (
                  <div key={item.id} className="border-b py-4">
                    <h3 className="text-lg font-semibold text-indigo-700">{item.medication.displayName}</h3>
                    <p className="text-gray-700"><strong>Category:</strong> {item.medication.category}</p>
                    <p className="text-gray-700"><strong>Prescription Required:</strong> {item.medication.prescriptionRequired ? 'Yes' : 'No'}</p>
                ...
                <p className="text-lg font-semibold text-indigo-800 mt-4">
